...
# Creació del grup en funció de la mediana de la primera sonda: ILMN_1653026 
...
unlist(as.list(exprs(gset_norm[gset_norm@featureData@data$ID=="ILMN_1653026",])>median_1))
...
table_DEG_median_1 <- topTable(data.fit.eb, number = Inf,adjust.method = "fdr",genelist = gset_norm@featureData@data)
# dim(table_DEG_median_1)

table_DEG_sig_median_1 <-table_DEG_median_1 %>% 
  filter(adj.P.Val<=0.05)

dim(table_DEG_sig_median_1) 

save(table_DEG_median_1, file="./RESULTATS_GSE36924/TAULES/table_DEG_median_1")
save(table_DEG_sig_median_1, file="./RESULTATS_GSE36924/TAULES/table_DEG_sig_median_1")
```

Hi ha 14 gens diferencialment expressats significatius entre els grups (en funció de la mediana 1) 
```{r}
load("./RESULTATS_GSE36924//TAULES/table_DEG_sig_median_1")
datatable_jm(table_DEG_sig_median_1,column = c("GO.Process", "GO.Function","GO.Process.ID", "GO.Function.ID"))
...
### GO_GSEA
```{r}
load(file="./RESULTATS_GSE36924//TAULES/table_DEG_median_1")
load(file="./RESULTATS_GSE36924//TAULES/table_DEG_sig_median_1")
...
table_DEG_complete<-
  table_DEG_median_1[table_DEG_median_1$Gene.ID!="",]
...
save(table_DEG_complete, file="./RESULTATS_GSE36924/TAULES/table_DEG_complete")
...
reducedTerms_median_1 <- reduceSimMatrix(simMatrix,
                                scores,
                                threshold=0.7,
                                orgdb="org.Hs.eg.db")


png("./RESULTATS_GSE36924/PLOTS/treemapplot_median_1.png",width = 900,height = 600,res=100)
treemapPlot(reducedTerms_median_1)
dev.off()
```

```{r}
knitr::include_graphics("./RESULTATS_GSE36924/PLOTS/treemapplot_median_1.png", dpi = 100)
```
...
save(kegg_gsea,file = "./RESULTATS_GSE36924/OBJECTES_R/kegg_gsea_median1")
...
kegg_gsea_df_median_1 <- kegg_gsea_df_p
save(kegg_gsea_df_median_1, file="./RESULTATS_GSE36924/TAULES/kegg_gsea_df_median_1")

png("./RESULTATS_GSE36924/PLOTS/kegg_graph_median_1.png",width = 900,height = 600,res=100)
kegg_graph
dev.off()
```

```{r}
load("./RESULTATS_GSE36924/TAULES/kegg_gsea_df_median_1")
datatable_jm(kegg_gsea_df_median_1, column = c("core_enrichment"))

```

```{r}
knitr::include_graphics("./RESULTATS_GSE36924/PLOTS/kegg_graph_median_1.png", dpi = 100)
```
...
png("./RESULTATS_GSE36924/PLOTS/hallmarks_median_1_graph.png",width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file="./RESULTATS_GSE36924/hallmarks_median_1")
write.csv(fgseaRes, file="./RESULTATS_GSE36924/hallmarks_median_1.csv")
...
png("./RESULTATS_GSE36924/PLOTS/hallmarks_median_1_graph_entrez_ID.png",width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file="./RESULTATS_GSE36924/hallmarks_median_1_graph_entrez_ID")
write.csv(fgseaRes, file="./RESULTATS_GSE36924/hallmarks_median_1_graph_entrez_ID.csv") 
...
png(paste0("./RESULTATS_GSE36924/PLOTS/C2_KEGG_median_graph.png"),width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file=paste0("./RESULTATS_GSE36924/TAULES/C2_KEGG_median"))
write.csv(fgseaRes, file=paste0("./RESULTATS_GSE36924/TAULES/C2_KEGG_median.csv")) 
...
png(paste0("./RESULTATS_GSE36924/PLOTS/C2_REACTOME_median_graph.png"),width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file=paste0("./RESULTATS_GSE36924/TAULES/C2_REACTOME_median"))
write.csv(fgseaRes, file=paste0("./RESULTATS_GSE36924/TAULES/C2_REACTOME_median.csv")) 
...
png(paste0("./RESULTATS_GSE36924/PLOTS/C6_oncogenic_median_graph.png"),width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file=paste0("./RESULTATS_GSE36924/TAULES/C6_oncogenic_median"))
write.csv(fgseaRes, file=paste0("./RESULTATS_GSE36924/TAULES/C6_oncogenic_median.csv")) 
...
png(paste0("./RESULTATS_GSE36924/PLOTS/C7_IMMUNOGENIC_median_graph.png"),width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file=paste0("./RESULTATS_GSE36924/TAULES/C7_IMMUNOGENIC_median"))
write.csv(fgseaRes, file=paste0("./RESULTATS_GSE36924/TAULES/C7_IMMUNOGENIC_median.csv")) 
...
# table(gset_norm@featureData@data$`Gene symbol`==genes_mol_sub[1])
...
# gen_in_matrix <- sum(gset_norm@featureData@data$`Gene symbol`== genes_mol_sub[i])
# if(gen_in_matrix>0){
# matriu_plac <-matriu_exprs[gset_norm@featureData@data$`Gene symbol`=="PLAC8",][1,]
# 
# matriu_2 <-matriu_exprs[
# rownames(matriu_exprs)==             
# gset_norm@featureData@data$ID[gset_norm@featureData@data$`Gene symbol`==genes_mol_sub[i]][1],]          
# 

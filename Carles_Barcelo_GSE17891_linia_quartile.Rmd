...
png(paste0(resultatsplots_l, "/C2_KEGG_quartile_graph.png"),width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file=paste0(resultatstaules_l, "/C2_KEGG_quartile"))
write.csv(fgseaRes, file=paste0(resultatstaules_l, "/C2_KEGG_quartile.csv")) 
...
png(paste0(resultatsplots_l, "/C2_REACTOME_quartile_graph.png"),width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file=paste0(resultatstaules_l, "/C2_REACTOME_quartile"))
write.csv(fgseaRes, file=paste0(resultatstaules_l, "/C2_REACTOME_quartile.csv")) 
...
png(paste0(resultatsplots_l, "/C6_oncogenic_quartile_graph.png"),width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file=paste0(resultatstaules_l, "/C6_oncogenic_quartile"))
write.csv(fgseaRes, file=paste0(resultatstaules_l, "/C6_oncogenic_quartile.csv")) 
...
png(paste0(resultatsplots_l, "/C7_IMMUNOGENIC_quartile_graph.png"),width = 900,height = 600,res=100)
fgseaRes_graph
dev.off()

save(fgseaRes, file=paste0(resultatstaules_l, "/C7_IMMUNOGENIC_quartile"))
write.csv(fgseaRes, file=paste0(resultatstaules_l, "/C7_IMMUNOGENIC_quartile.csv")) 
